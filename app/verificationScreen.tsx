...
//       if (!passedEmail) {
//         const data = await SecureStore.getItemAsync("my-token");
//         if (data) {
...
//     try {
//       const response = await onVerifyEmail?.(email, otpValue);
//       if (response?.success) {
//         Alert.alert("Success", "Your email has been verified!");
//         router.replace("/(inside)/home");
//       } else {
//         Alert.alert("Verification Failed", response?.msg || "Invalid OTP.");
//       }
//     } catch (error) {
//       Alert.alert("Error", "Something went wrong. Please try again.");
//     }
...
// //       }
// //     } else {
// //       Alert.alert("Error", "Verification function is not available.");
// //     }
// //   };
